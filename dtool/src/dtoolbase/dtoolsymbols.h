...
#define EXPCL_EMPTY
  ...
  #define EXPTP_DTOOL EXPORT_TEMPLATE
#else
  #define EXPCL_DTOOL IMPORT_CLASS
  #define EXPTP_DTOOL IMPORT_TEMPLATE
#endif

#ifdef BUILDING_DTOOLCONFIG
  #define EXPCL_DTOOLCONFIG EXPORT_CLASS
  #define EXPTP_DTOOLCONFIG EXPORT_TEMPLATE
#else
  #define EXPCL_DTOOLCONFIG IMPORT_CLASS
  #define EXPTP_DTOOLCONFIG IMPORT_TEMPLATE
#endif

#ifdef BUILDING_MISC
  #define EXPCL_MISC EXPORT_CLASS
  #define EXPTP_MISC EXPORT_TEMPLATE
#else /* BUILDING_MISC */
  #define EXPCL_MISC IMPORT_CLASS
  #define EXPTP_MISC IMPORT_TEMPLATE
#endif /* BUILDING_MISC */
